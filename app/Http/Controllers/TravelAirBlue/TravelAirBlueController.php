...
namespace App\Http\Controllers\TravelAirBlue;
...
class TravelAirBlueController extends Controller {
    ...
    public function one_way_trip_filter(Request $request) {
        ...
        try {
            ...
            $oneway_resp = $airblue->search_request($request->input());
//            print_r($oneway_resp); die();
            $search_data = $airblue->OutputAirSearch($oneway_resp,$request->from,$request->ticket_class,$flightType);
            ...
            if ($search_data['status'] == 'true') {
                ...
                $return = array(
                    'status' => '200',
                    'message' => 'One way search list AirBlue',
                    'result' => $dataObj
                );
            } else {
                $return = array(
    ...
    public function round_trip_filter(Request $request) {
        ...
        try {
            ...
            if ($search_data['status'] == 'true') {
                ...
                $return = array(
                    'status' => '200',
                    'message' => 'Round Trip search list AirBlue',
                    'result' => $dataObj
                );
            } else {
                $return = array(
